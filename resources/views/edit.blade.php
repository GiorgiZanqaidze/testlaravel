<x-layout>
    ...
    <form method="POST" action="/quotes/quote/{{$quote->slug}}/edit" class="flex justify-center flex-col items-center" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        <div class="mb-6">
            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your Quote name</label>
        ...
        <div class="mb-6">
            <label for="slug" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your Quote slug</label>
