<x-layout>
    ...
    <form method="POST" action="/quotes/quote/create" class="flex justify-center flex-col items-center" enctype="multipart/form-data">
        @csrf
        <div class="mb-6">
            <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your Quote name</label>
